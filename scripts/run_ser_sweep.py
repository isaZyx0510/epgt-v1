"""Run E4 symbol-error robustness sweep."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run SER sweep.")
    parser.add_argument("--config", default="configs/data/base_common_delay.yaml")
    parser.add_argument("--values", nargs="*", type=float, default=[0.0, 0.01, 0.05, 0.10, 0.20])
    ...
    parser.add_argument("--output", default="experiments/e4_symbol_error/sweep_metrics.json")
