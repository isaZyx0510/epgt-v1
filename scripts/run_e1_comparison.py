"""Run E1 clean comparison: oracle LS, hybrid, and direct-H."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run E1 method comparison.")
    ...
    parser.add_argument(
        "--output",
        default="experiments/e1_clean_transformer/comparison_metrics.json",
    )
