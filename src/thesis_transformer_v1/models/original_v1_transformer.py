"""Frozen original_v1 Transformer architecture snapshot.

This file intentionally preserves the first mean-pooling Transformer baseline.
Future architecture experiments should edit `transformer.py` or add new modules,
while keeping this file stable for reproducibility.
"""
